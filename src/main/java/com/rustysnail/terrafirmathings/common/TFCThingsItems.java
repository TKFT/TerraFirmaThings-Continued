...
public final class TFCThingsItems
{
    ...
    // Rope Bridge Block Item
    public static final DeferredItem<BlockItem> ROPE_BRIDGE_SEGMENT = ITEMS.register("rope_bridge",
        () -> new BlockItem(TFCThingsBlocks.ROPE_BRIDGE.get(), new Item.Properties().stacksTo(32)));
    ...
    // Rope Javelin
    public static final DeferredItem<RopeJavelinItem> BISMUTH_BRONZE_ROPE_JAVELIN = ITEMS.register("rope_javelin/bismuth_bronze",
        () -> new RopeJavelinItem(TFCTiers.BISMUTH_BRONZE, new Item.Properties().stacksTo(1).durability(TFCTiers.BISMUTH_BRONZE.getUses())
            .attributes(javelinAttributes(TFCTiers.BISMUTH_BRONZE))));
    public static final DeferredItem<RopeJavelinItem> BLACK_BRONZE_ROPE_JAVELIN = ITEMS.register("rope_javelin/black_bronze",
        () -> new RopeJavelinItem(TFCTiers.BLACK_BRONZE, new Item.Properties().stacksTo(1).durability(TFCTiers.BLACK_BRONZE.getUses())
            .attributes(javelinAttributes(TFCTiers.BLACK_BRONZE))));
    public static final DeferredItem<RopeJavelinItem> BLACK_STEEL_ROPE_JAVELIN = ITEMS.register("rope_javelin/black_steel",
        () -> new RopeJavelinItem(TFCTiers.BLACK_STEEL, new Item.Properties().stacksTo(1).durability(TFCTiers.BLACK_STEEL.getUses())
            .attributes(javelinAttributes(TFCTiers.BLACK_STEEL))));
    public static final DeferredItem<RopeJavelinItem> BLUE_STEEL_ROPE_JAVELIN = ITEMS.register("rope_javelin/blue_steel",
        () -> new RopeJavelinItem(TFCTiers.BLUE_STEEL, new Item.Properties().stacksTo(1).durability(TFCTiers.BLUE_STEEL.getUses())
            .attributes(javelinAttributes(TFCTiers.BLUE_STEEL))));
    public static final DeferredItem<RopeJavelinItem> BRONZE_ROPE_JAVELIN = ITEMS.register("rope_javelin/bronze",
        () -> new RopeJavelinItem(TFCTiers.BRONZE, new Item.Properties().stacksTo(1).durability(TFCTiers.BRONZE.getUses())
            .attributes(javelinAttributes(TFCTiers.BRONZE))));
    public static final DeferredItem<RopeJavelinItem> COPPER_ROPE_JAVELIN = ITEMS.register("rope_javelin/copper",
        () -> new RopeJavelinItem(TFCTiers.COPPER, new Item.Properties().stacksTo(1).durability(TFCTiers.COPPER.getUses())
            .attributes(javelinAttributes(TFCTiers.COPPER))));
    public static final DeferredItem<RopeJavelinItem> RED_STEEL_ROPE_JAVELIN = ITEMS.register("rope_javelin/red_steel",
        () -> new RopeJavelinItem(TFCTiers.RED_STEEL, new Item.Properties().stacksTo(1).durability(TFCTiers.RED_STEEL.getUses())
            .attributes(javelinAttributes(TFCTiers.RED_STEEL))));
    public static final DeferredItem<RopeJavelinItem> STEEL_ROPE_JAVELIN = ITEMS.register("rope_javelin/steel",
        () -> new RopeJavelinItem(TFCTiers.STEEL, new Item.Properties().stacksTo(1).durability(TFCTiers.STEEL.getUses())
            .attributes(javelinAttributes(TFCTiers.STEEL))));
    public static final DeferredItem<RopeJavelinItem> WROUGHT_IRON_ROPE_JAVELIN = ITEMS.register("rope_javelin/wrought_iron",
        () -> new RopeJavelinItem(TFCTiers.WROUGHT_IRON, new Item.Properties().stacksTo(1).durability(TFCTiers.WROUGHT_IRON.getUses())
            .attributes(javelinAttributes(TFCTiers.WROUGHT_IRON))));
    ...
    private static ItemAttributeModifiers javelinAttributes(Tier tier)
    {
        return ToolItem.productAttributes(tier, 0.7F, -2.6F);
    }
    ...
    public static final List<DeferredItem<CrownItem>> ALL_CROWNS = List.of(
        GOLD_CROWN_EMPTY, GOLD_CROWN_AGATE, GOLD_CROWN_AMETHYST, GOLD_CROWN_BERYL,
        GOLD_CROWN_DIAMOND, GOLD_CROWN_EMERALD, GOLD_CROWN_GARNET, GOLD_CROWN_JADE,
        GOLD_CROWN_JASPER, GOLD_CROWN_OPAL, GOLD_CROWN_RUBY, GOLD_CROWN_SAPPHIRE,
        GOLD_CROWN_TOPAZ, GOLD_CROWN_TOURMALINE,
        PLATINUM_CROWN_EMPTY, PLATINUM_CROWN_AGATE, PLATINUM_CROWN_AMETHYST, PLATINUM_CROWN_BERYL,
        PLATINUM_CROWN_DIAMOND, PLATINUM_CROWN_EMERALD, PLATINUM_CROWN_GARNET, PLATINUM_CROWN_JADE,
        PLATINUM_CROWN_JASPER, PLATINUM_CROWN_OPAL, PLATINUM_CROWN_RUBY, PLATINUM_CROWN_SAPPHIRE,
        PLATINUM_CROWN_TOPAZ, PLATINUM_CROWN_TOURMALINE
    );
    ...
    //Sling Ammo
    public static final DeferredItem<SlingAmmoItem> SLING_AMMO_HEAVY = ITEMS.register("sling_ammo/heavy",
        () -> new SlingAmmoItem(SlingAmmoItem.AmmoType.HEAVY, new Item.Properties().stacksTo(64)));
    public static final DeferredItem<SlingAmmoItem> SLING_AMMO_SPREAD = ITEMS.register("sling_ammo/spread",
        () -> new SlingAmmoItem(SlingAmmoItem.AmmoType.SCATTER, new Item.Properties().stacksTo(64)));
    public static final DeferredItem<SlingAmmoItem> SLING_AMMO_LIGHT = ITEMS.register("sling_ammo/light",
        () -> new SlingAmmoItem(SlingAmmoItem.AmmoType.LIGHT, new Item.Properties().stacksTo(64)));
    public static final DeferredItem<SlingAmmoItem> SLING_AMMO_FIRE = ITEMS.register("sling_ammo/fire",
        () -> new SlingAmmoItem(SlingAmmoItem.AmmoType.FIRE, new Item.Properties().stacksTo(64)));

    public static final List<DeferredItem<SlingAmmoItem>> ALL_SLING_AMMO = List.of(
        SLING_AMMO_HEAVY, SLING_AMMO_SPREAD, SLING_AMMO_LIGHT, SLING_AMMO_FIRE
    );

    //Rope Javelins
    public static final List<DeferredItem<RopeJavelinItem>> ALL_ROPE_JAVELINS = List.of(
        COPPER_ROPE_JAVELIN, BRONZE_ROPE_JAVELIN, BISMUTH_BRONZE_ROPE_JAVELIN,
        BLACK_BRONZE_ROPE_JAVELIN, WROUGHT_IRON_ROPE_JAVELIN, STEEL_ROPE_JAVELIN,
        BLACK_STEEL_ROPE_JAVELIN, BLUE_STEEL_ROPE_JAVELIN, RED_STEEL_ROPE_JAVELIN
    );

    //Hook Javelins
    public static final List<DeferredItem<HookJavelinItem>> ALL_HOOK_JAVELINS = List.of(
        STEEL_HOOK_JAVELIN, BLACK_STEEL_HOOK_JAVELIN, BLUE_STEEL_HOOK_JAVELIN, RED_STEEL_HOOK_JAVELIN
    );

    //Grindstones
    public static final DeferredItem<BlockItem> GRINDSTONE_BASE = ITEMS.register("grindstone_base",
        () -> new BlockItem(TFCThingsBlocks.GRINDSTONE_BASE.get(), new Item.Properties()));
    public static final DeferredItem<GrindstoneItem> GRINDSTONE_WHEEL_QUARTZ = ITEMS.register("grindstone_wheel/quartz",
        () -> new GrindstoneItem(GrindstoneItem.Tier.QUARTZ, new Item.Properties().stacksTo(1).durability(250)));
    public static final DeferredItem<GrindstoneItem> GRINDSTONE_WHEEL_STEEL = ITEMS.register("grindstone_wheel/steel",
        () -> new GrindstoneItem(GrindstoneItem.Tier.STEEL, new Item.Properties().stacksTo(1).durability(4200)));
    public static final DeferredItem<GrindstoneItem> GRINDSTONE_WHEEL_DIAMOND = ITEMS.register("grindstone_wheel/diamond",
